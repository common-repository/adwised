	...
	<p>
		<?php
			printf(
				...
				__( 'Thank you for installing %1$s!', 'adwised' ),
				$this->plugin->displayName
			); ?>
		<a href="<?php echo $setting_page; ?>"><?php esc_html_e( 'Click here', 'adwised' ); ?></a> <?php esc_html_e( 'to configure the plugin.', 'adwised' ); ?>
	</p>
</div>
